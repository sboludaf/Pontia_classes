    ...
    def __init__(
        ...
        **kwargs
        ...
        self.data_source = kendra.CfnDataSource(
            ...
            schedule="",  # Sin schedule para coincidir con configuración que funciona
        ...
        # Adjuntar la política al rol de Kendra
        kendra_role.attach_inline_policy(kendra_policy)
